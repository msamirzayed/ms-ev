jQuery(function ($) {
  ...
  $(".home-sliders").on("translate.owl.carousel", function () {
    $(
      ".main-banner-content b, .main-banner-content h1, .main-banner-content .typewrite"
    )
    ...
    $(".main-banner-content a")
      ...
      .css("opacity", "0");
    $(".banner-image")
      .removeClass("animate__animated animate__slideInUp")
      .css("opacity", "0");
  });
...
$(window).on(
  ...
  (function () {
    ...
    // Buy Now Btn
    // $('body').append("<a href='https://themeforest.net/checkout/85304586/create_account?_ga=2.142340722.1155538898.1648837867-1297998632.1635997908' target='_blank' class='buy-now-btn'>Buy Now</a>");
...
function setTheme(themeName) {
  localStorage.setItem("wezet_rtl_theme", themeName);
  document.documentElement.className = "theme-dark";
}
// function to toggle between light and dark theme
function toggleTheme() {
  if (localStorage.getItem("wezet_rtl_theme") === "theme-dark") {
...
function toggleLanguage() {
  var currentLanguage = document.getElementById("language-toggle").innerText;
  var targetLanguage = currentLanguage === "AR" ? "EN" : "AR";

  var currentPath = window.location.pathname;
  var newPath = currentPath.replace("/Test-" + targetLanguage + "/", "/");
